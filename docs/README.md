...
Everything in this docs/ tree works **without** a weside.ai account. The plugin runs all 23 skills standalone. Councils convene with nine generic role-lenses. Meetings at four Plan altitudes (Vision/Saga/Epic/Story). The pipeline ships stories end-to-end.
