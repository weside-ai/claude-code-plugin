...
FLAVOR_PROFILES: dict[str, dict] = {
    ...
    "landing": {
        ...
        "meetings": {
            ...
            "initiative": ["product_owner", "marketing", "orchestrator"],
            "refinement": ["product_owner", "marketing"],
        },
    ...
    "infrastructure": {
        ...
        "meetings": {
            ...
            "initiative": ["architect", "security", "orchestrator"],
            "refinement": ["architect", "security"],
        },
