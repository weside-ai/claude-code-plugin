...
**Status:** DEPRECATED as of WA-772. Use `doc-architect` via `/we:docs`.
...
That works for the minute it was written, then rots. `doc-architect` (WA-772)
...
2. Invoke `doc-architect` with the request verbatim
3. Return the `doc-architect` response
